export const EXPERIENCE = [
    {
        "workTitle": "Development and Support Co-Op",
        "description": [
            "Worked as a Client Success Team Member and shadowed my peers to learn more about the tools and processes",
            "Started learning CONNECT Messaging Platform for email marketing to support client requests",
            "Learned HTML, CSS, Javascript and JQuery to support client with Email content fixes",
            "Introduced to PHP for the first time, did not only learn the concepts but created hand-written document for future reference",
            "Learned about API for the first time and learned how to use Postman application",
            "After learning PHP concepts, started focusing on Symfony framework to build my first project (Patient Medication Tracker)"
        ],
        "timeline": "June 2017 - September 2017",
        "image": "https://www.dropbox.com/s/d9ru8zpmstcv5cc/inbox-marketer.jpg?raw=1",
        "company": {
            "name": "Inbox Marketer",
            "link": "https://trendlineint.wpengine.com/inbox-marketer-now-trendline/"
        }
    },
    {
        "workTitle": "Development and Support Co-Op",
        "description": [
            "Built a server-side rendering CRUD based application for an Admin portal using NodeJS and express",
            "The portal included: user login, multi-selection, bulk edit and custom information based on user data",
            "Learned about Authorization and Authentication flows for the first time and applied them to the portal",
            "Presented the work in company wide show and tell",
            "Based on facing some issues with server-side rendering applications, decided to use framework for building the second service",
            "Started learning ReactJs framework to build the User Portal",
    ...
    },
    {
        ...
        "description": [
            ...
            "The most important skill that I gained from this co-op is automation",
